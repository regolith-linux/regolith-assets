...
//  size(dimx,dimy,P3D);
  ...
  //takecolor("/home/kgilmer/sketchbook/wallpaper/nord-palette.png");
  ...
  //background(#E5E9F0);
  //takecolor("/home/kgilmer/sketchbook/wallpaper/pollockShimmering.gif");
  
  cgrid = new int[dimx*dimy];
  cracks = new Crack[maxnum];
  
  //background = loadImage("scott-webb-UjupleczBOY-unsplash.jpg");
...
void mousePressed() {
  save("kgwh" + int(random(99999)) + ".png");
  begin();
}
